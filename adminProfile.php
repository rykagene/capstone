                ...
                <div class="modal-content">
                    ...
                    <div class="modal-content">
                        <div class="modal-body" style="padding:40px 50px;">
                            ...
                            <p style="font-size: 16px;"><span style="font-weight: bold;">Gender:&nbsp;&nbsp;</span><span
                            ...
                            <hr>
                            <form role="form" style="padding-top:0;">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-9 text-secondary gender">
                                                <select class="form-control" id="department-input">
                                                    ...
                                                    echo "selected" ?>
                                                        value='CAFA'>COLLEGE OF ARCHITECTURE AND FINE ARTS (CAFA)</option>
                                                    ...
                                                    echo "selected" ?>
                                                        value='CCJE'>COLLEGE OF CRIMINAL JUSTICE EDUCATION (CCJE)</option>
                                                    <option <?php if ($row['department'] == 'CHTM')
                                                    echo "selected" ?>
                                                        value='CHTM'>COLLEGE OF HOSPITALITY AND TOURISM MANAGEMENT (CHTM)
                                                    </option>
                                                    <option <?php if ($row['department'] == 'CICT')
                                                    echo "selected" ?>
                                                        value='CICT'>COLLEGE OF INFORMATION AND COMMUNICATIONS TECHNOLOGY
                                                        (CICT)
                                                    </option>
                                                    ...
                                                    echo "selected" ?>
                                                        value='CLAW'>COLLEGE OF LAW (CLAW)</option>
                                                    ...
                                                    echo "selected" ?>
                                                        value='COED'>COLLEGE OF EDUCATION (COED)</option>
                                                    <option <?php if ($row['department'] == 'CS')
                                                    echo "selected" ?> value='CS'>
                                                        COLLEGE OF SCIENCE (CS)</option>
                                                    <option <?php if ($row['department'] == 'CSER')
                                                    echo "selected" ?>
                                                        value='CSER'>COLLEGE OF SPORTS, EXERCISE AND RECREATION (CSER)
                                                    </option>
                                                    <option <?php if ($row['department'] == 'CSSP')
                                                    echo "selected" ?>
                                                        value='CSSP'>COLLEGE OF SOCIAL SCIENCES AND PHILOSOPHY (CSSP)
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
