                            ...
                            <div class="table-responsive">
                                ...
                                <section class="table__body">
                                    <table id="customers_table">
                                        <thead>
                                            <tr>
                                                <th id="all-reservation-id"> Reservation ID <span class="icon-arrow">&UpArrow;</span></th>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="archive_start_date" placeholder="Start Date" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control"  id="archive_end_date" placeholder="End Date" readonly>
                                                </div>
                                            </div>
                                            <div class= "ml-5">
                                                <button id="filter" class="btn btn-outline-info btn-sm">Filter Date</button>
                                                <button id="archive_reset" class="btn btn-outline-warning btn-sm ">Reset</button>
                                            </div>
                                        </div>
                                        ...
                                        <section class="table__body">
                                            <table id="archivedReservation_table">
                                                <thead>
                                                    <tr>
                                                        <th id="archive-reservation-id">Reservation ID<span class="icon-arrow">&UpArrow;</span></th>
                                                        <th> User ID <span class="icon-arrow">&UpArrow;</span></th>
                                                        <th> User <span class="icon-arrow">&UpArrow;</span></th>
                                                        <th> Seat ID <span class="icon-arrow">&UpArrow;</span></th>
                                                        <th> Date <span class="icon-arrow">&UpArrow;</span></th>
                                                        ...
                                                        <tr id="archivedReservation_row_<?php echo $row['reservation_id']; ?>">                                                 
                                                            ...
                                                            <td>
                                                                ...
                                                                <button type="button" class="btn btn-light btn-rounded btn-icon restore_btn"
                                                                    data-reservation-id="<?php echo $row['reservation_id']; ?>">
                                                                    <i class="bi bi-arrow-counterclockwise text-warning" style="font-size: 1.3em;"></i>
                                                                </button>
                                                                <button type="button" class="btn btn-light btn-rounded btn-icon delete_btn"
                                                                    data-reservation-id="<?php echo $row['reservation_id']; ?>">
