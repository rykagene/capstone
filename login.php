...
<body>
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h1 class="modal-title fs-2" id="exampleModalLabel">Terms and Conditions</h1>
        ...
        <div class="modal-body">
          ...
          <p>These terms and conditions outline the rules and regulations for the use of Bulacan State University 's
            Website, located at https://www.soar.edu.ph/.</p>

          <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use SOAR if
          ...
          <p>We employ the use of cookies. By accessing SOAR, you agreed to use cookies in agreement with the Bulacan
            State University 's Privacy Policy. </p>
          ...
          <p>Unless otherwise stated, Bulacan State University and/or its licensors own the intellectual property rights
            for all material on SOAR. All intellectual property rights are reserved. You may access this from SOAR for
            your own personal use subjected to restrictions set in these terms and conditions.</p>

          <p>You must not:</p>
          <ul>
            <li>Republish material from SOAR</li>
            <li>Sell, rent or sub-license material from SOAR</li>
            <li>Reproduce, duplicate or copy material from SOAR</li>
            <li>Redistribute content from SOAR</li>
          </ul>
          ...
          <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
            certain areas of the website. Bulacan State University does not filter, edit, publish or review Comments
            prior to their presence on the website. Comments do not reflect the views and opinions of Bulacan State
            University ,its agents and/or affiliates. Comments reflect the views and opinions of the person who post
            their views and opinions. To the extent permitted by applicable laws, Bulacan State University shall not be
          ...
          <p>Bulacan State University reserves the right to monitor all Comments and to remove any Comments which can be
          ...
          <p>You hereby grant Bulacan State University a non-exclusive license to use, reproduce, edit and authorize
          ...
          <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
            ...
            of Bulacan State University ; and (d) the link is in the context of general resource information.</p>
          ...
          <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
            website, you must inform us by sending an e-mail to Bulacan State University . Please include your name,
          ...
          <p>No use of Bulacan State University 's logo or other artwork will be allowed for linking absent a trademark
            license agreement.</p>
  ...
  <div class="modal fade" id="privacy" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-2" id="exampleModalLabel">Privacy Policy</h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          ...
          <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the
            collection and use of information in accordance with this Privacy Policy.>Free Privacy Policy Generator</a>.
          </p>
          ...
          <ul>
            ...
            <li>
              <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                or &quot;Our&quot; in this Agreement) refers to Bulacan State University Philippines, Guinhawa, City of
                Malolos, Bulacan.</p>
            </li>
            <li>
            ...
            <li>
              <p><strong>Website</strong> refers to SOAR, accessible from <a href="https://www.soar.edu.ph/"
                  rel="external nofollow noopener" target="_blank">https://www.soar.edu.ph/</a></p>
            </li>
            <li>
          ...
          <ul>
            <li>
              <p>By email: officeofthepresident@bulsu.edu.ph</p>
            </li>
            <li>
              <p>By visiting this page on our website: <a href="https://www.soar.edu.ph/"
                  rel="external nofollow noopener" target="_blank">https://www.soar.edu.ph/</a></p>
            </li>
            <li>
              <p>By phone number: 919-7800</p>
            </li>
          </ul>
        </div>
        <div class="modal-footer">
