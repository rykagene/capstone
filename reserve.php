  ...
  <header class="header-outer">
    <div class="header-inner responsive-wrapper">
      ...
      <nav class="header-navigation">
        ...
        <a class="active" href="reserve.php">RESERVE SEAT</a>
            ...
            .catch(error => console.error('Error fetching disabled dates:', error));
                  ...
                  <div class="form-floating mb-3">
                    <input type="time" class="form-control" id="start_time" name="start_time" required
                      onchange="getEndTime()" min="<?php echo date('H:i'); ?>" value="">
                  ...
                  <div class="form-floating mb-3">
                    <input type="time" class="form-control-plaintext" readonly id="end_time" name="end_time"
                      required="required">
                  ...
                  <div class="form-check form-switch form-switch-md">
                    ...
                    <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault" name="viewOption"
                      checked onchange="handleFormChange()" style="--background-color: #FF0000;">
