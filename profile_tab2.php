<div class="reservations-wrapper">
        ...
        if (mysqli_num_rows($ongoing_result) > 0) {
            while ($row = mysqli_fetch_assoc($ongoing_result)) {
                ...
                echo "<p><ion-icon name='time-outline'></ion-icon> {$start_time} - {$end_time} Remaining Time: {time_spent}</p></div>";
                ...
                echo "<a href='timer.php' class='btn btn-outline-danger btn-sm'; return false;'>View Timer</a>";
                echo "</div>";
